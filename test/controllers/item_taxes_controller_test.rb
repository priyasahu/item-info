...
class ItemTaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_tax" do
    assert_difference('ItemTax.count') do
      post item_taxes_url, params: { item_tax: { item_id: @item_tax.item_id, tax: @item_tax.tax, tax_type: @item_tax.tax_type } }
    end
  ...
  test "should update item_tax" do
    patch item_tax_url(@item_tax), params: { item_tax: { item_id: @item_tax.item_id, tax: @item_tax.tax, tax_type: @item_tax.tax_type } }
